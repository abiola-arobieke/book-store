...
```sh
  git clone https://github.com/abiola-arobieke/book-store.git
```
...
- [ ] **Add comments and reviews to a book**
...
Feel free to check the [issues page](https://github.com/abiola-arobieke/book-store.git/issues).
